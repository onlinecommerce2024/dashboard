...
<div class="container-perfil">
    ...
    <h1 class="logo"><span class="nombre-empresa">Datos del perfil</h1>
    <div class="wrapper animated bounceInLeft">
      <div class="info-empresa">
        <h3>Online Commerce</h3>
        <ul class="servicios">
          <li>Tienes una tienda, agregala a online commerce desde aca . <br> <button class="uk-button uk-button-text tendero">Ser tendero</button></li>
          <br><li>Quieres generar ingresos, trabaja con nosotros como domiciliario. <br> <button class="uk-button uk-button-text tendero">Ser domiciliario</button></li>
