    ...
    <form class="form" action="#" method="post">
        ...
        <div class="flex-column">
          ...
          <div class="inputForm">
            ...
            <input type="email" class="input" placeholder="Ingrese su Correo" name="correo" id="correo">
          </div>
        ...
        <div class="flex-column">
          ...
          <div class="inputForm">
            ...
            <input type="password" class="input" name="password" placeholder="Ingrese su contraseña" id="contrasena">
