...
@media screen and (max-width: 768px) {
    ...
    <div class="ContainerTotal">
        ...
        <div class="ContainerLeft">
            ...
            <!--Encabezado-->
            <h1 style="font-weight: 700;">Tu Carrito</h1> 

            <div class="Envio">
                <h2 style="font-weight: 700;">Envios</h2>

                <p>"¡Aprovecha nuestra increíble oferta! Por compras superiores a 100 mil pesos, te ofrecemos envío GRATIS. ¡Es la oportunidad perfecta para llenar tu carrito con todo lo que necesitas y recibirlo en la puerta de tu hogar sin costo adicional! No esperes más, ¡haz tu pedido ahora!"</p>
            </div>
        ...
        <div class="ContainerRight">
            ...
            <!--Detalles de Compra-->
            <div class="carrito">
                <h2 style="font-weight: 500;">Detalles de la Compra</h2>
                <ul>
                    <li>Producto 1 - $20</li>
                    <li>Producto 2 - $30</li>
                ...
                <div class="subtotal">
                    <h3 style="font-weight: 900;">Total: $500.000</h3>
                </div>
                ...
                <div class="opciones-pago">
                    ...
                    <div class="opcion">
                        <img src="./dashboard/imagenes/visa.png" alt="Visa">
                    </div>
                    <div class="opcion">
                        <img src="./dashboard/imagenes/pago.png" alt="Mastercard">
                    </div>
                    <div class="opcion">
                        <img src="./dashboard/imagenes/paypal.png" alt="PayPal" >
                    </div>
                   

                </div>

                <button class="boton-pagar">Ir a Pagar</button>
    ...
    <h1 class="Barra-Recomienda">Nuestras Recomendaciones</h1>
